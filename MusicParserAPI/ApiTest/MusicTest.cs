...
namespace ApiTest
{
    public class MusicTest
    {
        ...
        [Fact]
        public void LanguageGetTest()
        {
            // Arrange
            string language = "ENG";
            TrackNameTranslation trackNameTranslation = new TrackNameTranslation()
            {
                Language = language
            };
            ...
            // Act
            // (get)
            string testLanguage = trackNameTranslation.Language;

            // Assert
            Assert.Equal(language, testLanguage);
        }
        [Fact]
        public void LanguageSetTest()
        {
            ...
            // Act
            // (set)
            trackNameTranslation.Language = language2;
            // (get)
            string testLanguage = trackNameTranslation.Language;

            // Assert
            Assert.Equal(language2, testLanguage);
        }

        [Fact]
        public void TranslationGetTest()
        {
            // Arrange
            string translation = "\\qosk\\wionsd//tinfkb";
            TrackNameTranslation trackNameTranslation = new TrackNameTranslation()
            {
            ...
            // Act
            // (get)
            string testTranslation = trackNameTranslation.Translation;

            // Assert
            Assert.Equal(translation, testTranslation);
        }
        [Fact]
        public void TranslationSetTest()
        {
            // Arrange
            string translation = "\\qosk\\wionsd//tinfkb";
            string translation2 = "\\98awhgoizn\\toignfdb//tinfkb";
            TrackNameTranslation trackNameTranslation = new TrackNameTranslation()
            {
                Translation = translation
            };
            ...
            // Act
            // (set)
            trackNameTranslation.Translation = translation2;
            // (get)
            string testTranslation = trackNameTranslation.Translation;

            // Assert
            Assert.Equal(translation2, testTranslation);
        }

        [Fact]
        public void TrackNameTranslationGetTest()
        {
            // Arrange
            string language = "ENG";
            string translation = "\\qosk\\wionsd//tinfkb";
            ...
            TrackNameTranslationList TrackNameTranslationList = new TrackNameTranslationList()
            {
            ...
            // Act
            // (get)
            TrackNameTranslation testTrackNameTranslation = TrackNameTranslationList.Track_name_translation;

            // Assert
            Assert.Equal(trackNameTranslation, testTrackNameTranslation);
        }
        [Fact]
        public void TrackNameTranslationSetTest()
        {
            // Arrange
            string language = "ENG";
            string translation = "\\qosk\\wionsd//tinfkb";
            ...
            TrackNameTranslation trackNameTranslation2 = new TrackNameTranslation();
            TrackNameTranslationList TrackNameTranslationList = new TrackNameTranslationList()
            {
                Track_name_translation = trackNameTranslation
            };
            ...
            // Act
            // (set)
            TrackNameTranslationList.Track_name_translation = trackNameTranslation2;
            // (get)
            TrackNameTranslation testTrackNameTranslation = TrackNameTranslationList.Track_name_translation;

            // Assert
            Assert.Equal(trackNameTranslation2, testTrackNameTranslation);
        }
        ...
        public void TrackNameTranslationListGetTest()
        {
            ...
            List<TrackNameTranslationList> translationList = new List<TrackNameTranslationList>()
            {
            ...
            // Act
            // (get)
            List<TrackNameTranslationList> testTranslationList = track.Track_name_translation_list;
        ...
        public void TrackNameTranslationListSetTest()
        {
            ...
            List<TrackNameTranslationList> translationList2 = new List<TrackNameTranslationList>();
            Track track = new Track()
            {
                Track_name_translation_list = translationList
            };
